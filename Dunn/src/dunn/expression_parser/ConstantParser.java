...
public class ConstantParser implements Parser {
	...
	public ConstantParser() {
		...
		Parser quotedText = new FromToParser(quote, quote);
		NumericParser number = new NumericParser();
		parser = TerminalParser.wrap(new OrParser(new Parser[] { quotedText, number }));
	}
