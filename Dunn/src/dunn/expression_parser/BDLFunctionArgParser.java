...
public class BDLFunctionArgParser implements Parser {

	private Parser quotedText;

	public BDLFunctionArgParser() {
		CharacterParser quote = new CharacterParser("\"");
		quotedText = TerminalParser.wrap(new FromToParser(quote, quote));
	}

	public String parse(InputSequence in) throws CannotParseException {
		ExpressionParser expression = new ExpressionParser();
		Parser parser = new OrParser(new Parser[] { quotedText, expression });
