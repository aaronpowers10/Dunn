...
public class ReservedWordParser implements Parser {
	...
	public ReservedWordParser() {
		...
		TableParser resWord = new TableParser("/doe2_res/ResWordDictionary.txt", new SpaceDelimitedRowFactory());
		parser = TerminalParser.wrap(resWord);
	}
